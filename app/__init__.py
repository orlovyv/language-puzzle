...
from app.routes import analysis, auth, billing, documents, knowledge, learn, spa, users, words
...
def create_app() -> FastAPI:
    ...
    for module in (auth, documents, analysis, knowledge, words, learn, users, billing):
